...
/**
 * CoupleTableElement,作为父组件包含2个table组件，使它们的沟通更加方便,构造函数请使用
 &lt;CoupleTableElement /&gt;
 * @author danding001
 ...
 *
 */
var SelectCourse_CoupleTableElement=React.createClass({
        ...
        if(this.state.data$options!==undefined&&this.state.data$options!==null)
        {
            ...
            ProxyQ.queryHandle(
                ...
                function(ob) {
                    ...
                    var query=ob.query; //实现跳转到查看培养计划页面
                    if(query !== undefined && query !==null){
                        var url=query.url;
                        var params=query.params;
                        if(url!==undefined && url!==null){
                            this.setState({isDirection:true,url:url});
                        }
                    }
                        ...
                        var title$index2=ob.title$index2;
                        ...
                        if(data!==undefined&&data!==null) {
                                ...
                                && !isNaN(parseInt(title$index1)))
                            {
                                ...
                                tags[parseInt(title$index2)]["data-options"].title=title[title$index2]; //培养方案的title
    ...
    getInitialState:function(){
        ...
        return {tags:tags,dataS:dataS,initialDataS:initialDataS,data$options:data$options,isDirection:false,url:url};
    },
    ...
    render:function(){
        ...
        if(this.state.isDirection===true){ //重定向跳转
                ...
                if(this.state.tags!==undefined&&this.state.tags!==null) {
                    ...
                    var tables=this.state.dataS.map(function(item,i) {
                        ...
                        return (<Table tdBasic={true} multiEnable={1} key={i} index={i}
                                       ...
                                       data-options={data$options} data={data} align="left" title-
                                       color="transparent"
...
export default SelectCourse_CoupleTableElement;