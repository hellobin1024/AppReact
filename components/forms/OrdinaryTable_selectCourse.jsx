 ...
 * 4.增加表尾控件,tail
 */
var OrdinaryTable_selectCourse =React.createClass({
        ...
        if(evt!==undefined&&evt!==null)
        {
            ...
            if(target.getAttribute('data-comp')!==undefined&&target.getAttribute('data-comp')!==null)
            {
                ...
                if(Object.prototype.toString.call(target.getAttribute('data-query')=='[object String]'))
                    queryData=eval('('+target.getAttribute('data-query')+')');
                else
                    queryData=target.getAttribute('data-query');
...
export default OrdinaryTable_selectCourse;