...
/***/ function(module, exports, __webpack_require__) {
	...
	function Pack() {
	    ...
	    (0, _reactDom.render)(_react2.default.createElement(_SidebarMenuElement2.default, { 'data-options': data$options, style: basicStyle }), document.getElementById('react$render$menu'));
	}
	...
	var SidebarMenuElement = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.state.data$initialed !== true) {
	            ...
	            return _react2.default.createElement('ul', { className: 'sidebar-menu' });
	        } else {
	            //数据已经初始化
	            var data;
