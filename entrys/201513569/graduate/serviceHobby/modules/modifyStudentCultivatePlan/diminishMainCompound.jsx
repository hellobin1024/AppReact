...
import SelectCourse_CoupleTableElement from '../../../../../../components/compounds/coupleTable/selectCourse_CoupleTableElement.jsx';
        ...
        if(this.state.buttonOption=="cultivate"){  //渲染培养计划和培养方案
            return(
                <div className="diminishMain">
                    <SelectCourse_CoupleTableElement tags={tags} data-options={data$options}/>
